export default {
  ...
  'APP_REQUEST_TRANSFER_UPDATE': 'APP_REQUEST_TRANSFER_UPDATE',
  'APP_COMMERCE_VIEW': 'APP_COMMERCE_VIEW',
  'APP_CANCEL_BOPIS_ORDER':'APP_CANCEL_BOPIS_ORDER',
  'APP_PWA_STANDALONE_ACCESS': 'APP_PWA_STANDALONE_ACCESS',
  'APP_PROOF_OF_DELIVERY_PREF_UPDATE': 'APP_PROOF_OF_DELIVERY_PREF_UPDATE'
}